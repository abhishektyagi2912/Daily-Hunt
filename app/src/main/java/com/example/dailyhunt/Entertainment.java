...
public class Entertainment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerViewHome = v.findViewById(R.id.rv_entertainment);
        shimmerFrameLayout = v.findViewById(R.id.shimmer5);
    ...
    private void findNews(){
        String url = "https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=3f3fe8154a364d35a28b87fce4eee68a";
