...
public class Health extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerViewHome = v.findViewById(R.id.rv_health);
        shimmerFrameLayout = v.findViewById(R.id.shimmer4);
    ...
    private void findNews(){
        String url = "https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=3f3fe8154a364d35a28b87fce4eee68a";
