...
public class Sports extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerViewHome = v.findViewById(R.id.rv_sports);
        shimmerFrameLayout = v.findViewById(R.id.shimmer2);
    ...
    private void findNews(){
        String url = "https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=3f3fe8154a364d35a28b87fce4eee68a";
